...
describe('serializeResults', function () {
    it('should output valid JSON', function () {
        ...
        dredge.serializeResults(obj).should.equal('[{"id":"foo","name":"bar"},{"id":"baz","name":"foobar"}]');
    });
});
...
describe('outputFile', function () {
    ...
    it('should write a JSON file to disk without error', function (done) {
        dredge.outputFile(str, filepath, function (err) {
    ...
    it('should throw error if arguments are invalid', function () {
        dredge.outputFile.bind(dredge, '', filepath).should.throw();
        dredge.outputFile.bind(dredge, null, filepath).should.throw();
        dredge.outputFile.bind(dredge, undefined, filepath).should.throw();
        dredge.outputFile.bind(dredge, {}, filepath).should.throw();
        dredge.outputFile.bind(dredge, str, '').should.throw();
        dredge.outputFile.bind(dredge, str, null).should.throw();
        dredge.outputFile.bind(dredge, str, undefined).should.throw();
        dredge.outputFile.bind(dredge, str, {}).should.throw();
        dredge.outputFile.bind(dredge, str, filepath, 'durr').should.throw();
        dredge.outputFile.bind(dredge, str, filepath, null).should.throw();
        dredge.outputFile.bind(dredge, str, filepath, {}).should.throw();
        dredge.outputFile.bind(dredge, str, filepath).should.throw();
    });
});
